            ...
            <section className="py-24 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    <div className="bg-white p-10 rounded-3xl shadow-xl border border-green-100">
                        ...
                        {status === 'error' && (
                            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl text-red-600 font-medium flex items-center gap-2">
                                ❌ {message}
                            </div>
                        )}
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-green-50 border border-gray-200 rounded-xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 transition"
                                        placeholder="Your name"
                                    />
                                </div>
                                <div>
                                    <label className="block text-gray-600 font-medium mb-2 text-sm uppercase tracking-wide">Phone</label>
                                    <input
                            ...
                            <div>
                                <label className="block text-gray-600 font-medium mb-2 text-sm uppercase tracking-wide">Subject *</label>
                                <input
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-green-50 border border-gray-200 rounded-xl px-5 py-3 h-32 focus:outline-none focus:ring-2 focus:ring-green-500 transition resize-none"
                            ...
                            <button
                                ...
                                className="w-full bg-green-700 text-white font-bold py-4 rounded-xl hover:bg-green-800 transition shadow-lg transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {status === 'loading' ? (
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4">
                                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" title="Facebook"
                                    ...
                                    className="w-12 h-12 rounded-2xl flex items-center justify-center shadow-md hover:scale-110 hover:shadow-lg transition-transform duration-200">
                                ...
                                <a href="https://wa.me/94771234567" target="_blank" rel="noopener noreferrer" title="WhatsApp"
